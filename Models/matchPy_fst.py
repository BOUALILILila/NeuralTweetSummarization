...
#dataset =loader.load_data(stage="train",path='/projets/iris/PROJETS/lboualil/CORPUS/tweets/worse_bm25/train_data_2016_2017.csv')
...
#create preprocessor
train_split=dataset
test_split=loader.load_data(stage="train",path='/projets/iris/PROJETS/lboualil/CORPUS/tweets/train_data_2017_nist.csv')
...
# save the model
model.save('/projets/iris/PROJETS/lboualil/Models/MatchPy/MatchPy_full_2015-2016_fasttext_CBOW')
preprocessor.save('/projets/iris/PROJETS/lboualil/Preprocessors/MatchPy/MatchPy_full_2016_fasttext_CBOW')
