...
if __name__ == "__main__":
    ...
    with open(day_ids_path, 'r') as f:
            day_ids=json.load(f)
    pred=pd.read_csv('/projets/iris/PROJETS/lboualil/CORPUS/predictions_2017/MatchPy/MatchPy_cross_fasttext_cbow_2017/predictions_2017_norm.csv', index_col=0)
    ...
    d=ds[0]
    path=f'/projets/iris/PROJETS/lboualil/CORPUS/predictions_2017/MatchPy/MatchPy_cross_fasttext_cbow_2017/pred_{d}.csv'
